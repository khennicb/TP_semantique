...
class AffNode extends  InstNode {
    ...
    public String toString() { 
        ...
        return affecte.toString() + " " + assign.toString() + " " + expr.toString() + ";" ;
    }
...
class CondNode extends  InstNode {
    ...
    public String toString() { 
        ...
        String str = theif.toString() + " (" + thecond.toString() +") then \n" + thenpart.toString() ;
        if(elsepart != null) {
            str = str + "else \n" + elsepart.toString();
        }
        str = str + "endif;";
...
class WhileNode extends  InstNode {
    ...
    public String toString() { 
        ...
        return thewhile.toString() + " " + thecond.toString() + " loop \n" + body.toString() + "endloop;";
    }
...
class ReadNode extends  InstNode {
    ...
    public String toString() { 
        return tt.toString() + " " + tr.toString();
    }
...
class WriteNode extends  InstNode {
    ...
    public String toString() { 
        return tt.toString() + " " + written.toString();
    }
...
class AssertNode extends  InstNode {
    ...
    public String toString() { 
        return tt.toString() + "  " + asserted.toString();
    }
...
class ExprNode extends MiniLgNode {
    ...
    public String toString() {
        ...
        switch (theKind) {
            case BINARY:
                return "(" + fg.toString() + " "+ operatorToken.toString() + " " + fd.toString() + ")";
            case UNARY:
                return  "(" + operatorToken.toString() + " " + fg.toString() + ")";
            case BOOLCONST:
